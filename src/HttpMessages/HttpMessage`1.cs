...
public record HttpMessage<TValue> : HttpMessage
{
    ...
    private HttpMessage(TValue? value, HttpStatusCode statusCode, string? message, ExternalProps? externalProps) : base(statusCode, message, externalProps ?? new())
    {
        _value = value;
    }
    ...
    internal static HttpMessage<TValue> With(TValue? value, string? message, HttpStatusCode statusCode, ExternalProps? externalProps = null)
